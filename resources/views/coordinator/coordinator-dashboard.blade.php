        ...
        <main class="ml-lg-2">
          ...
          >
            ...
            <div class="d-none d-lg-block page-title">
              <h3>Overview</h3>
              <small>Hi {{$details->userdetail->firstname}}, welcome back</small>
            </div>
            <div class="d-lg-none">
          ...
          <section class="mt-2 main-body mb-5">
            <div class="row mx-auto">
              <div class="col-md-7 px-0">
                <div class="wallets">
                  <div class="card foodbank-wallet-card">
                    <h6>Foodbank Balance</h6>
                    <h2 class="pt-3">₦ {{$details->wallet->balance}}</h2>
                  </div>
                  <div class="card loan-wallet-card">
                    <h6>Loan Balance</h6>
                    <h2 class="pt-3">₦ {{$details->loanwallet->balance}}</h2>
                  </div>
                </div>
                <div class="card transaction-history">
                  <h6 class="transaction-title">Transaction History</h6>
              ...
              <div class="col-md-5">
                ...
                <div class="card orders">
                  <table class="table table-borderless">
                    <thead>
                      <tr>
                        <td class="font-weight-bold">Orders</td>
                    ...
                    <div class="table-body">
                      <tbody>
                        ...
                        <tr>
                          <td>Order ox{{$order->id}}fb</td>
                          <td class="success">{{$controller->getOrderStatus($order->id)}}</td>
                        </tr>
                        @endforeach
