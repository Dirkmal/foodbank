...
<html lang="en">
  ...
  <body class="auth-body h-100 my-5">
  @include('includes.alert')
    <section class="card login-card p-3">
      <div class="header">
        <img src="../images/foodbank 1.png" alt="foodbank_logo" />

        <h4 class="loginhead">Create Your Account</h4>
      </div>
        ...
        <div class="row mx-auto">
          ...
          <div class="col-md-12">
            <div class="input-box">
              <span
                class="iconify"
                data-icon="gridicons:institution"
                data-inline="false"
                id="iconn"
              ></span>
            ...
            <div class="input-box">
              ...
              >
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M13.3313 0H20V15H13.3313V0ZM0 0H6.66563V15H0V0Z"
                  fill="#008753"
                />
              </svg>
              <input
          ...
          <div class="col-md-12">
            <div class="input-check">
              ...
              <label for="Terms" class="d-inline">
          ...
          <div class="col-md-12">
            <div class="loginfootnote">
              <p>
                ...
                <a class="loginfootlink" href="./sign-in"> Login</a>
              </p>
            </div>
          </div>
        </div>
    ...
    <!-- <div class="big-wrapper-register mx-auto">
      <div class="wrapper-register">
        <div class="header">
          <img src="../images/foodbank 1.png" alt="foodbank_logo" />
          <h3 class="loginhead">Create your account</h3>
        </div>
        <div class="input-box">
          <span
            class="iconify"
        ...
        <div class="input-box">
          ...
          <select id="institution" name="institution">
            <option value="School">Select Institution</option>
            <option value="School">University Of Nigeria</option>
            <option value="School">University Of Nigeria</option>
          </select>
        </div>
        <div class="input-box">
        ...
        <div class="loginfootnote">
          <p>
            Already have an account?
            <a class="loginfootlink" href="login.html"> Login</a>
          </p>
        </div>
      </div>
    </div> -->
