      ...
      <div class="col-12 col-lg-9 col-xl-10 px-0">
        <main class="ml-lg-2">
          ...
          <section class="mt-2 main-body mb-5">
            <div
              class="card transaction-history mt-0 available-items success-card"
            >
              <div class="success-body">
                ...
                <div class="text-body">
                  ...
                  <p>
                    Your Order with the code ox{{session('order_id')}}fb has been received and is
                    being processed. Check Dashboard for Notifications.
                  </p>
                  <div class="back-to-home">
                    <a href="./dashboard" class="btn"
                      >Back to Dashbooard</a
                    >
                  </div>
                </div>
              </div>
