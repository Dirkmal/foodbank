              ...
              <div class="modal-content">
                ...
                <div class="modal-body py-5">
                  <div class="container text-center mx-auto">
                    ...
                    <a href="../signout"><button class="btn px-5 create-campaign-btn logout">
                        LOGOUT
                      </button></a>
                      <button
      ...
      <div class="col-12 col-lg-9 col-xl-10 px-0">
        <main class="ml-lg-2">
          ...
          <section class="mt-2 main-body mb-5">
            <div class="row mx-auto">
              <div class="col-md-8">
                <div class="card wallets p-4 text-center stats">
                  <div class="row">
                  <div class="col-md-4">
                      <h1>{{count($details->pending_orders)}}</h1>
                      <p>Pending Orders</p>
                    </div>

                    <div class="col-md-4">
                      <h1>{{count($details->approved_orders)}}</h1>
                      <p>Processed Orders</p>
                    </div>

                    <div class="col-md-4">
                      <h1>{{count($details->completed_orders)}}</h1>
                ...
                <div class="card transaction-history">
                  <h6 class="transaction-title">New Orders</h6>
                  <table class="table table-borderless admin-table">
                    <tbody>
                      ...
                      @foreach ($details->pending_orders as $order)
                      <tr>
                        ...
                        ox{{$order->id}}fb
                          <div
                            ...
                            type="button"
                            data-toggle="modal"
                            data-target="#pendingModal{{$order->id}}"
                        ...
                        <td>{{$order->amount}}</td>
                        <td><a href="../process-order/{{$order->id}}"><div class="bg-success">Accept</div></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
              ...
              <div class="col-md-4">
                <div class="card orders admin-orders">
                  <table class="table table-borderless">
                    <thead>
                      <tr>
                        <td class="font-weight-bold">Completed Orders</td>
                      </tr>
                    </thead>
                    <div class="table-body">
                      <tbody>
                      @foreach ($details->completed_orders as $order)
                        <tr>
                          <td>ox{{$order->id}}fb</td>
                          ...
                          <td
                            ...
                            type="button"
                            data-toggle="modal"
                            data-target="#completedModal{{$order->id}}"
                            class="btn btn-success"
                            colspan="2"
                          >
              ...
              <div class="col-md-12">
                <div class="card transaction-history">
                  <h6 class="transaction-title text-capitalize">
                    Approved Orders
                  </h6>
                  <table class="table table-borderless admin-table">
                    <tbody>
                    @foreach ($details->approved_orders as $order)
                      ...
                      <tr>
                        ...
                        ox{{$order->id}}fb
                          <div
                            ...
                            type="button"
                            data-toggle="modal"
                            data-target="#approvedModal{{$order->id}}"
                            class="btn btn-success"
                            colspan="2"
                          >
                            <small class="text-success">View Details</small>
                        ...
                        <td>{{$order->amount}}</td>
                        <td><a href="../deliver-order/{{$order->id}}"><div class="bg-success">Deliver</div></a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body py-5">
            <div class="container mx-auto">
              ...
              <tbody>
              <th>Products</th>
                 @foreach ($controller->getOrderProducts($order->id) as $product)                             
                      <tr>
                        <td><small>{{$product->quantity}}X </small></td>
                        <td>{{$controller->getProductname($product->product_id)}}</td>
                      </tr>
              ...
              <th>Billing</th>
              <?php 
              $billing = $controller->getBillingDetails($order->id);
              ?>
                     @if(@$billing[0]->name)                       
                      <tr><td>Institution Name: </td> <td> {{$billing[0]->name}}</td> </tr>
                      <tr><td>Address:  </td> <td>{{$billing[0]->address}}</td> </tr>
                      <tr> <td>City: </td>   <td> {{$billing[0]->city}}</td> </tr>
                      <tr> <td>State: </td>   <td> {{$billing[0]->state}}</td> </tr>

                      @else
                      <tr><td>Name: </td> <td> {{$controller->getUserDetails($order->user_id)->firstname}} {{$controller->getUserDetails($order->user_id)->lastname}}</td> </tr>
                      <tr><td>Phone: </td> <td> {{$controller->getUser($order->user_id)->phone}}</td> </tr>
                      <tr><td>Email: </td> <td> {{$controller->getUser($order->user_id)->email}}</td> </tr>
