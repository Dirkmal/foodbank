<?php
   ...
   $details= $controller->loans();  
   $orders= $controller->dashboard(); 
            ...
            <div class="row mx-auto">
              <div class="col-md-8">
                <div class="card wallets p-4 text-center stats">
                  <div class="row">
                    <div class="col-md-4">
                      <h1>{{count($details->disbursed)}}</h1>
                      <p>Foodloans disbursed</p>
                    </div>
                    <div class="col-md-4">
                      <h1>{{count($details->declined)}}</h1>
                      <p>Foodloans Declined</p>
                    </div>
                    <div class="col-md-4">
                      <h1>{{count($details->pending)}}</h1>
                      <p>Pending Loan Requests</p>
                    </div>
                  </div>
                </div>
                <div class="d-block d-md-none card notifications-card add-item">
                  <a href="./store">
                    ...
                    <small>Add New item to store</small>
                  </a>
                </div>
                <div class="card transaction-history">
                  <h6 class="transaction-title">Logs</h6>
              ...
              <div class="col-md-4">
                <div class="d-none d-md-block card notifications-card add-item">
                  <a href="./store">
                    <div class="icon-container">
                      <span
                        class="iconify"
                ...
                <div class="card orders admin-orders">
                  <table class="table table-borderless">
                    <thead>
                      <tr>
                        <td class="font-weight-bold">Orders On Transit</td>
                      </tr>
                    </thead>
                    <div class="table-body">
                      ...
                      @foreach ($orders->approved_orders as $order)
                      <tr>
              ...
              <div class="col-md-12">
                <div class="card transaction-history">
                  <h6 class="transaction-title text-capitalize">Loan Status</h6>
                  <table class="table table-borderless admin-table">
                    <tbody>
                    
                    @foreach ($details->loans as $loan)
                      <tr>
                        <td><small>{{$loan->created_at}}</small></td>
                        
                        <td>{{$loan->amount}}</td>
                        <td><div class="bg-success">{{$controller->getLoanStatus($loan->id)}}</div></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
