            ...
            <div class="card transaction-history mt-0 available-items admin-store mb-3">
                ...
                @csrf
                  ...
                  >
                    ...
                    <p><img id="output" src="{{$product->image_url}}" width="200"/></p>
                
                   
                  </div>
                  <input type="number" id="productName" value="{{$id}}" name="product_id" hidden>
                  ...
                  <div class="form-group mt-4">
                    ...
                    <input type="number" step=0.01 class="form-control" value="{{$product->amount}}" id="productPrice" name="amount">
                  </div>
                  <div class="form-group mt-4">
                    <label for="productPrice">In Stock</label>
                    <input type="number" class="form-control" value="{{$product->in_stock}}" id="in_stock" name="in_stock">
                  </div>
