      ...
      <div class="col-12 col-lg-9 col-xl-10 px-0">
        <main class="ml-lg-2">
          ...
          <section class="mt-2 main-body mb-5">
            <div class="card transaction-history mt-0 available-items admin-store mb-3">
                <form action="/add-product" method="post" enctype='multipart/form-data'>
                @csrf
                  <div class="form-group">
                  <input type="file"  accept="image/*" name="file" id="file"  onchange="loadFile(event)" style="display: none;" class="form-control">
                    <label class="file-label" for="file" style="cursor: pointer;">
                    Product Image 
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                  ...
                  <div class="form-group mt-4">
                    ...
                    <input type="number" step=0.01 class="form-control" id="productPrice" name="amount">
                  </div>
                  <div class="form-group mt-4">
                    <label for="productPrice">In Stock</label>
            ...
            <div class="row mx-auto">
              <div class="col-12 px-0">
                <div class="card transaction-history mt-0 available-items admin-store">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-6 col-md-4 mt-4">
                      <div class="card item-card">
                        ...
                        <div class="card-body">
                          <p class="text-truncate item-title">{{$product->name}}</p>
                          <small class="item-price"> ₦ {{$product->amount}} </small>
                          <div class="row" style="margin-left:70px; margin-top:10px;">
                          <a href="./product/{{$product->id}}"> <button style="margin-left:10px;" type="button" class="btn btn-success">Edit</button></a>
                         <button   style="margin-left:10px;" type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal{{$product->id}}"> Delete</button>
          ...
          @foreach ($products as $product)  <!-- Modal -->
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <a href="../delete-product/{{$product->id}}">  <button type="button" class="btn btn-danger">Proceed</button></a>
                  </div>
                </div>
              </div>
            </div>
